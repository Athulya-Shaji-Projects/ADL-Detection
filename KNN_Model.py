...
k = 5 # You can choose any value of k, which represents the number of nearest neighbors to consider
...
predicted_label=knn.predict(mfccs_scaled_features)
pred_proba = knn.predict_proba(mfccs_scaled_features)
